...
Admission/confirmation proposal, supervisor notes, timeline, funding, and scope.

**Seed:** expand [`../../docs/evaluation/research-proposal.md`](../../docs/evaluation/research-proposal.md)
into a 5–10 page doctoral proposal (gap, questions, method, feasibility, contribution).
